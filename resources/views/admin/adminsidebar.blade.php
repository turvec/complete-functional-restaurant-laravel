    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('all_events')}}">View All Events</a></li>
                    <li><a href="{{route('add_event')}}">Add an Event</a></li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('add_reviews')}}">Add Reviews</a></li>
                    <li><a href="{{route('all_reviews')}}">See All Reviews</a></li>
                </ul>
            </li>
