            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('upload_reviews')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="input-group mb-4 input-primary">
                                    ...
                                    <input  name="star_rating" type="number" class="form-control" placeholder="Maximun number of Star Rating is 5" max="5" min="1">
