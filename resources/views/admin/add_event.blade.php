            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('upload_event')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="input-group mb-4 input-primary">
                                    <div class="input-group-append">
                                        <span class="input-group-text">Event Title</span>
                                    </div>
                                    <input name="title" type="text" class="form-control" placeholder="Input Title" required>
                                ...
                                <div class="input-group mb-4 input-primary">
                                    ...
                                    <input name="date" type="date"  placeholder="Input Date" >
                                </div>
                                <div class="input-group mb-4 input-primary">
                                    <div class="input-group-append">
