                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table table-border checkout-table">
                            <tbody>
                                ...
                                <tr>
                                    <td class="hidden-xs">
                                    <a href="#"><img src="/foodimage/{{$cart->image}}" alt="" class="respimg"></a>
                                    </td>
                                    <td>
                                        <h5 class="product-name">{{$cart->title}}</h5>
                                    </td>
                                    <td class="hidden-xs">
                                        <h5 class="order-money">${{$cart->price}}</h5>
                                    </td>
                                    <td>
                                        <input type="number" name="cartin1" value="{{$cart->quantity}}" max="50" min="1" class="order-count">
                                    </td>
                                    <td>
                                        <h5 class="order-money">${{$cart->price}}</h5>
                                    </td>
                                    <td class="pr-remove">
                                    <a href="{{route('delete_cart',$cart->id)}}" title="Remove"><i class="fal fa-times"></i></a>
                                    </td>
                                </tr>
                                @endforeach
