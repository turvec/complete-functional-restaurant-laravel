...
<div>
    ...
    <div class="content">
        ...
        <section class="parallax-section dark-bg hidden-section" data-scrollax-parent="true">
            ...
            <div class="brush-dec"></div>
            <div class="bg par-elem bg_tabs" data-bg="images/bg/14.jpg"
        ...
        <section class="parallax-section dark-bg hidden-section" data-scrollax-parent="true">
            <div class="brush-dec2"></div>
            <div class="brush-dec"></div>
            <div class="bg par-elem bg_tabs" data-bg="images/bg/12.jpg"
                data-scrollax="properties: { translateY: '30%' }"></div>
            <div class="overlay"></div>
            <div class="container">
                <div class="video_section-title fl-wrap">
                    <h4>Our promo video</h4>
                    <h2>Get ready to start your exciting journey. <br> Our restaurant will lead you through the amazing
                        food world.</h2>
                    <div class="dots-separator fl-wrap"><span></span></div>
                </div>
                <a href="https://vimeo.com/10322316" class="promo-link big_prom     image-popup"><span
                        class="color-bg"><i class="fas fa-play"></i></span></a>
            </div>
        </section>
        <!--  section  end-->
        <!--  section  -->
